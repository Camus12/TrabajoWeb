...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { contrasena: @administrator.contrasena, usuario: @administrator.usuario } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { contrasena: @administrator.contrasena, usuario: @administrator.usuario } }
